...
#ifdef NDEBUG
#define suplogdebug(...)
#define suplogcrit(...) PhidgetLog_loge(NULL, 0, NULL, PSUPLS, PHIDGET_LOG_CRITICAL, __VA_ARGS__)
#define suplogerr(...) PhidgetLog_loge(NULL, 0, NULL, PSUPLS, PHIDGET_LOG_ERROR, __VA_ARGS__)
#define suplogwarn(...) PhidgetLog_loge(NULL, 0, NULL, PSUPLS, PHIDGET_LOG_WARNING, __VA_ARGS__)
#define suploginfo(...) PhidgetLog_loge(NULL, 0, NULL, PSUPLS, PHIDGET_LOG_INFO, __VA_ARGS__)
#define suplogverbose(...) PhidgetLog_loge(NULL, 0, NULL, PSUPLS, PHIDGET_LOG_VERBOSE, __VA_ARGS__)
#else
