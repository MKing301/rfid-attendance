...
#ifdef NDEBUG
#define wslogdebug(...)
#define wslogcrit(...) PhidgetLog_loge(NULL, 0, NULL, WSSRC, PHIDGET_LOG_CRITICAL, __VA_ARGS__)
#define wslogerr(...) PhidgetLog_loge(NULL, 0, NULL, WSSRC, PHIDGET_LOG_ERROR, __VA_ARGS__)
#define wslogwarn(...) PhidgetLog_loge(NULL, 0, NULL, WSSRC, PHIDGET_LOG_WARNING, __VA_ARGS__)
#define wsloginfo(...) PhidgetLog_loge(NULL, 0, NULL, WSSRC, PHIDGET_LOG_INFO, __VA_ARGS__)
#define wslogverbose(...) PhidgetLog_loge(NULL, 0, NULL, WSSRC, PHIDGET_LOG_VERBOSE, __VA_ARGS__)
#else
