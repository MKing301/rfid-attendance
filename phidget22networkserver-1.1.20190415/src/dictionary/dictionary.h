...
#ifdef NDEBUG
#define dslogdebug(...)
#define dslogcrit(...) PhidgetLog_loge(NULL, 0, NULL, DICTSTORELS, PHIDGET_LOG_CRITICAL, __VA_ARGS__)
#define dslogerr(...) PhidgetLog_loge(NULL, 0, NULL, DICTSTORELS, PHIDGET_LOG_ERROR, __VA_ARGS__)
#define dslogwarn(...) PhidgetLog_loge(NULL, 0, NULL, DICTSTORELS, PHIDGET_LOG_WARNING, __VA_ARGS__)
#define dsloginfo(...) PhidgetLog_loge(NULL, 0, NULL, DICTSTORELS, PHIDGET_LOG_INFO, __VA_ARGS__)
#define dslogverbose(...) PhidgetLog_loge(NULL, 0, NULL, DICTSTORELS, PHIDGET_LOG_VERBOSE, __VA_ARGS__)
#else
